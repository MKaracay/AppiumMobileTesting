...
public class CloudTesting {
    public static String userName = "muratkaracay1";
    public static String accessKey = "xB3KfBbiVrUiBvxB9Gg6";
    ...
    public void test1() throws Exception{
        ...
        //break 10 minutes
        //curl -u "muratkaracay1:xB3KfBbiVrUiBvxB9Gg6" -X POST "https://api-cloud.browserstack.com/app-automate/upload" -F "data={\"url\": \"https://cybertek-appium.s3.amazonaws.com/etsy.apk\"}
        desiredCapabilities.setCapability("app", "bs://f2dbeab9f1031b39ac79c9856ecb258f07d68b06");
